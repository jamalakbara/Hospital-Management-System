                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="breadcrumb-holder">
                                <h1 class="main-title float-left">Edit Accountant</h1>
                                <ol class="breadcrumb float-right">
                                    <li class="breadcrumb-item">Home</li>
                                    <li class="breadcrumb-item">Accountants</li>
                                    <li class="breadcrumb-item active">Edit Accountants</li>
                                </ol>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <div class="card mb-3 ">
                                ...
                                <div class="card-body">
                                    ...
                                    <form autocomplete="off" action="<?= base_url("accountant/edit/".$accountant[0]["acc_id"])?>" method="post">
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                <label for="id">Accountant ID</label>
                                                <input class="form-control" type="text" name="id" id="id" readonly value="<?= $accountant[0]["acc_id"]?>">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control" id="accName" placeholder="Accountant Name"
                                                    autocomplete="off" name="accName" value="<?= $accountant[0]["acc_name"]?>">
                                                ...
                                                <div class="form-check">
                                                    <label class="form-check-label">
                                                        <input class="form-check-input" type="radio" name="gridRadios"
                                                            id="gridRadios1" value="active" <?php if($accountant[0]["status"] == 'active'):?>checked<?php endif ?>>
                                                        Active
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <label class="form-check-label">
                                                        <input class="form-check-input" type="radio" name="gridRadios"
                                                            id="gridRadios1" value="inactive" <?php if($accountant[0]["status"] == 'inactive'):?>checked<?php endif ?>>
                                                        Inactive
                                                    </label>
                                                </div>
                                            </div>
